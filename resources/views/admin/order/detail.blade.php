...
@section('content')
    <section>
        <h1 class="font-bold text-gray-800 text-2xl">Order Detail</h1>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" class="pb-6 pl-4">
                                <a href="{{ route('order.complete', $data->id) }}" class="gap-2 inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-gradient-to-br from-green-400 to-green-600 rounded-lg shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
