  ...
  <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
      ...
      <div class="relative bg-white rounded-lg shadow">
          ...
          <div class="p-6 space-y-6">
              <form action="{{ route('admin.tables.update', $data->id) }}" method="POST" class="flex flex-col gap-4" id="createForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="relative">
                    ...
                    <input type="text" name="name" class="bg-transparent border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5 pl-10" placeholder="Enter Category's name" value="{{ $data->name }}">
                  </div>
                  @if(isset($errors))
