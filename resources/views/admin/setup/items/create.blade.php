  ...
  <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
      ...
      <div class="relative bg-white rounded-lg shadow">
          ...
          <div class="p-6 space-y-6">
              <form action="{{ route('admin.items.store') }}" method="POST" class="flex flex-col gap-4" id="createForm" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                  ...
                  <div class="relative">
                    ...
                    <input type="text" name="name" id="email-adress-icon" class="bg-transparent border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5 pl-10 " placeholder="Enter Item's name" value="{{ old('name') }}">
                  </div>
                  @if(isset($errors))
                  ...
                  <div class="relative">
                    ...
                    <select name="categories_id" id="countries" class="bg-transparent border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5 pl-10 ">
                      ...
                      @foreach ($categories as $c)
                          <option {{ old('categories_id') == $c->id ? 'selected' : '' }} value="{{ $c->id }}">{{ $c->name }}</option>
                      @endforeach
                    </select>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="relative">
                    ...
                    <input type="number" name="price" class="bg-transparent border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5 pl-10 " placeholder="Enter Item's Price" value="{{ old('price') }}">
                  </div>
                ...
                <div class="form-group">
                  <label for="img" class="border border-gray-200 border-dashed rounded-lg flex justify-center py-6">
                    <div id="previewText" class="flex flex-col items-center justify-center">
                      <i class="fa-solid fa-image"></i>
                      Upload Image Here
                    </div>
                    <img src="" style="display: none" class="w-1/3" alt="" id="previewArea">
                  </label>
